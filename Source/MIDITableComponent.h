...
/*
*/
class MIDITableComponent : public Component, public Button::Listener, public TableListBoxModel, public ChangeListener, public TextCellManager
{
public:
    MIDITableComponent(MIDIRelayManager& _relayManager, OSCTargetManager& _targetManager);
    ~MIDITableComponent();
...
private:
    ...
    {
    public:
        ButtonCustomComponent (MIDITableComponent& td)  : owner (td)
        {
