...
/*
*/
class ParameterComponent : public Component, public Button::Listener, public TableListBoxModel, public ChangeListener, public TextCellManager
{
public:
    ParameterComponent(RelayAudioProcessor& processor);
    ~ParameterComponent();
...
private:
    ...
    {
    public:
        ButtonCustomComponent (ParameterComponent& td)  : owner (td)
        {
